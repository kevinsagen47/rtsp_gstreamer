...
#vlc -v rtsp://127.0.0.1:8554/stream1 #only real/helix rtsp servers supported for now
...
class TestRtspMediaFactory(GstRtspServer.RTSPMediaFactory):
    ...
    def do_create_element(self, url):
        ...
        #pipeline = " v4l2src ! videoconvert ! queue ! video/x-raw,format=I420 ! videoscale ! x264enc tune=zerolatency bitrate=500 speed-preset=superfast ! rtph264pay name=pay0 config-interval=1 pt=96" #Webcam
